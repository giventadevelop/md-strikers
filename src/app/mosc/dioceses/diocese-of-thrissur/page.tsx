...
export const metadata = {
  title: 'Diocese of Thrissur',
  description: 'Learn about the Diocese of Thrissur of the Malankara Orthodox Syrian Church.',
};

const dioceseofthrissurPage = () => {
  return (
...
export default dioceseofthrissurPage;
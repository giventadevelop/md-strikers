...
export const metadata = {
  ...
  description: 'Mar Gregorios Orthodox Christian Student Movement (MGOCSM) is the student wing of the Malankara Orthodox Syrian Church. The students and senior leaders of our c...',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="w-20 h-20 bg-primary rounded-lg flex items-center justify-center mx-auto mb-6 sacred-shadow-lg">
              <span className="text-primary-foreground text-4xl font-bold" role="img" aria-label="Mar Gregorios Orthodox Christian Student Movement (MGOCSM)">🎓</span>
            </div>
            <h1 className="font-heading font-semibold text-4xl text-foreground mb-4">
              Mar Gregorios Orthodox Christian Student Movement (MGOCSM)
            </h1>
            <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Mar Gregorios Orthodox Christian Student Movement (MGOCSM) is the student wing of the Malankara Orthodox Syrian Church. The students and senior leaders of our church who were residing in Madras...
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              <div className="bg-background rounded-lg sacred-shadow p-8">
                <h2 className="font-heading font-semibold text-2xl text-foreground mb-6">
                  About Mar Gregorios Orthodox Christian Student Movement (MGOCSM)
                </h2>
                <div className="space-y-4 font-body text-muted-foreground leading-relaxed">
                  <p>Mar Gregorios Orthodox Christian Student Movement (MGOCSM) is the student wing of the Malankara Orthodox Syrian Church. The students and senior leaders of our church who were residing in Madras...</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            Learn more about how you can participate in the activities and programs of Mar Gregorios Orthodox Christian Student Movement (MGOCSM).
          </p>

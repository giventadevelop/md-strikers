...
export const metadata = {
  ...
  description: 'The antecedents of the St.Thomas Orthodox Vaidhika Sanghom can be traced back to the period of St.Gregorios of Parumala. The Saint, whose organizational skills ...',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              The antecedents of the St.Thomas Orthodox Vaidhika Sanghom can be traced back to the period of St.Gregorios of Parumala. The Saint, whose organizational skills and vision for the Malankara Orthodox...
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
              <div className="bg-background rounded-lg sacred-shadow p-8">
                <h2 className="font-heading font-semibold text-2xl text-foreground mb-6">
                  About St. Thomas Orthodox Vaidika Sanghom
                </h2>
                <div className="space-y-4 font-body text-muted-foreground leading-relaxed">
                  <p>The antecedents of the St.Thomas Orthodox Vaidhika Sanghom can be traced back to the period of St.Gregorios of Parumala. The Saint, whose organizational skills and vision for the Malankara Orthodox...</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            Learn more about how you can participate in the activities and programs of St. Thomas Orthodox Vaidika Sanghom.
          </p>

...
export const metadata = {
  ...
  description: 'Learn about the orthodox churches relations of the Malankara Orthodox Syrian Church.',
};

const orthodoxchurchesPage = () => {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="w-20 h-20 bg-primary rounded-lg flex items-center justify-center mx-auto mb-6 sacred-shadow-lg">
              <span className="text-primary-foreground text-4xl font-bold" role="img" aria-label="Orthodox Churches">⛪</span>
            </div>
            <h1 className="font-heading font-semibold text-4xl text-foreground mb-4">
              Orthodox Churches
            </h1>
            <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Relations with other Orthodox jurisdictions worldwide
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="bg-background rounded-lg sacred-shadow p-8">
                ...
                <div className="mb-8">
                  <Image
                    src="/images/ecumenical/orthodox-churches.jpg"
                    alt="Orthodox Churches"
                    width={500}
                    height={300}
...
export default orthodoxchurchesPage;